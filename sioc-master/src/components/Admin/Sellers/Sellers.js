    ...
    render() {
        return (
            <Container fluid className="animated fadeIn">
                <Row>
                    <Col sm="12">
                        <h2>Vendedores <Button color="light" onClick={this.toggle} style={{ marginBottom: '1rem' }}><FontAwesome name="plus"/> Crear nuevo</Button></h2>
                ...
                <Row>
                    <Col sm="12">
                        <Table hover>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">Alguien Vendedor</th>
